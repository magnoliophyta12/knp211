package com.ctb.rest.repository;

import com.ctb.rest.model.Contact; // импорт класса Contact, который представляет сущность JPA, с которой будет работать репозиторий
